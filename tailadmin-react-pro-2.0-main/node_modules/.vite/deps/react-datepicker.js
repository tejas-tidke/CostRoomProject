...
var CalendarContainer = function(_a2) {
  ...
  return import_react.default.createElement("div", { className, "aria-label": ariaLabel, role: inline ? void 0 : "dialog", "aria-modal": inline ? void 0 : "true", translate: "no" }, children);
};
...
var WeekNumber = (
  ...
  function(_super) {
    ...
    WeekNumber2.prototype.render = function() {
      ...
      return import_react.default.createElement("div", { ref: this.weekNumberEl, className: clsx(weekNumberClasses), "aria-label": "".concat(ariaLabelPrefix, " ").concat(this.props.weekNumber), onClick: this.handleClick, onKeyDown: this.handleOnKeyDown, tabIndex: this.getTabIndex(), role: "gridcell" }, weekNumber);
    };
    return WeekNumber2;
  }(import_react.Component)
);
var Week = (
  ...
  function(_super) {
    ...
    Week2.prototype.render = function() {
      ...
      return import_react.default.createElement("div", { className: clsx(weekNumberClasses, customWeekClassName), role: "row" }, this.renderDays());
    };
    return Week2;
  }(import_react.Component)
);
  ...
  function(_super) {
    ...
    Month2.prototype.render = function() {
      ...
      return import_react.default.createElement(
        "div",
        { role: "table" },
        this.props.dayNamesHeader && import_react.default.createElement("div", { role: "rowgroup" }, this.props.dayNamesHeader),
        this.props.monthHeader && import_react.default.createElement("div", { role: "rowgroup" }, this.props.monthHeader),
        import_react.default.createElement("div", { className: this.getClassNames(), onMouseLeave: !this.props.usePointerEvent ? this.handleMouseLeave : void 0, onPointerLeave: this.props.usePointerEvent ? this.handleMouseLeave : void 0, "aria-label": formattedAriaLabel, role: "rowgroup" }, this.renderWeeks()),
        this.props.monthFooter && import_react.default.createElement("div", { role: "rowgroup" }, this.props.monthFooter)
      );
    };
    return Month2;
  }(import_react.Component)
    ...
    function Calendar2(props) {
      ...
      _this.header = function(date, customDayNameCount) {
        ...
        if (_this.props.showWeekNumbers) {
          dayNames.push(import_react.default.createElement(
            "div",
            { key: "W", className: "react-datepicker__day-name ".concat(disabled ? "react-datepicker__day-name--disabled" : ""), role: "columnheader" },
            import_react.default.createElement("span", { className: "react-datepicker__sr-only" }, "Week number"),
            import_react.default.createElement("span", { "aria-hidden": "true" }, _this.props.weekLabel || "#")
          ));
        }
        return dayNames.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset2) {
          ...
          if (_this.props.renderCustomDayName) {
            ...
            return import_react.default.createElement("div", { key: offset2, role: "columnheader", className: clsx("react-datepicker__day-name", weekDayClassName, disabled ? "react-datepicker__day-name--disabled" : "") }, customContent);
          }
          return import_react.default.createElement(
            "div",
            ...
            import_react.default.createElement("span", { className: "react-datepicker__sr-only" }, fullDayName),
            import_react.default.createElement("span", { "aria-hidden": "true" }, weekDayName)
          );
        }));
      };
      ...
      _this.renderCurrentMonth = function(date) {
        ...
        return import_react.default.createElement("h2", { className: classes.join(" ") }, isValid2(date) ? formatDate(date, _this.props.dateFormat, _this.props.locale) : "");
      };
      ...
      _this.renderDayNamesHeader = function(monthDate, customDayNameCount) {
        ...
        return import_react.default.createElement("div", { className: "react-datepicker__day-names", role: "row" }, _this.header(monthDate, customDayNameCount));
      };
      _this.renderDefaultHeader = function(_a2) {
        var monthDate = _a2.monthDate, i = _a2.i;
        var headerContent = import_react.default.createElement(
          "div",
      ...
      _this.renderCustomHeader = function(headerArgs) {
        ...
        return import_react.default.createElement("div", { className: "react-datepicker__header react-datepicker__header--custom", onFocus: _this.props.onDropdownFocus }, (_b = (_a2 = _this.props).renderCustomHeader) === null || _b === void 0 ? void 0 : _b.call(_a2, _assign(_assign(_assign({}, _this.state), showYearPicker && { visibleYearsRange }), { customHeaderCount: i, monthDate, changeMonth: _this.changeMonth, changeYear: _this.changeYear, decreaseMonth: _this.decreaseMonth, increaseMonth: _this.increaseMonth, decreaseYear: _this.decreaseYear, increaseYear: _this.increaseYear, prevMonthButtonDisabled, nextMonthButtonDisabled, prevYearButtonDisabled, nextYearButtonDisabled })));
      };
      ...
      _this.renderInputTimeSection = function() {
        ...
        if (_this.props.selectsRange) {
          ...
          return import_react.default.createElement(
            ...
            null,
            import_react.default.createElement(InputTime, _assign({}, Calendar2.defaultProps, _this.props, { date: startTime, timeString: startTimeString, onChange: function(time2) {
              var _a3, _b2;
            ...
            import_react.default.createElement(InputTime, _assign({}, Calendar2.defaultProps, _this.props, { date: endTime, timeString: endTimeString, onChange: function(time2) {
              var _a3, _b2;
        ...
        return import_react.default.createElement(InputTime, _assign({}, Calendar2.defaultProps, _this.props, { date: time, timeString, onChange: function(time2) {
          var _a3, _b2;
      ...
      _this.renderAriaLiveRegion = function() {
        ...
        if (!isValid2(_this.state.date)) {
          return import_react.default.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" });
        }
...
var PopperComponent$1 = function(props) {
  ...
  if (props.popperContainer) {
    popper = (0, import_react.createElement)(props.popperContainer, {}, popper);
  }
