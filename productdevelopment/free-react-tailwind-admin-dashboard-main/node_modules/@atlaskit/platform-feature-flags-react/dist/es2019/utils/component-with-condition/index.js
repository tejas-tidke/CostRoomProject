...
export function componentWithCondition(condition, ComponentTrue, ComponentFalse) {
  const ComponentWithCondition = /*#__PURE__*/forwardRef((props, ref) => condition() ?
  /*#__PURE__*/
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  React.createElement(ComponentTrue, _extends({}, props, {
    ref: ref
  })) :
  /*#__PURE__*/
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  React.createElement(ComponentFalse, _extends({}, props, {
    ref: ref
  })));
