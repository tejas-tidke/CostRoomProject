...
function createInternalAPI() {
  ...
  function getCount() {
    var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      type = _ref4.type;
    if (!(0, _platformFeatureFlags.fg)('platform-dst-open-layer-observer-layer-type')) {
      if (namespace) {
        var _namespaceToLayerRegi, _namespaceToLayerRegi2;
        return (_namespaceToLayerRegi = (_namespaceToLayerRegi2 = namespaceToLayerRegistry.get(namespace)) === null || _namespaceToLayerRegi2 === void 0 ? void 0 : _namespaceToLayerRegi2.size) !== null && _namespaceToLayerRegi !== void 0 ? _namespaceToLayerRegi : 0;
      }
