...
export default function SpendBreakdownChart() {
  ...
  return (
    <div className="w-[628px] h-[400px] overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
